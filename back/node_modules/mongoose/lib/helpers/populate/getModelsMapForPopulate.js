...
module.exports = function getModelsMapForPopulate(model, docs, options) {
  ...
  if (!isStrictPopulateDisabled && allSchemaTypes.length === 0 && options._localModel) {
      const pathToUse = options._fullPath || options.path;
      return new StrictPopulate(pathToUse);
  }
